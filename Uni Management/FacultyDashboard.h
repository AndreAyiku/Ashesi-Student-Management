#pragma once
#include "FacutlyProfile.h"
#include "FacultyAccess.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(16, 283);
			this->button5->Margin = System::Windows::Forms::Padding(2);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(143, 24);
			this->button5->TabIndex = 8;
			this->button5->Text = L"Grade Management";
			this->button5->UseVisualStyleBackColor = true;
			this->button5->Click += gcnew System::EventHandler(this, &FacultyDashboard::button5_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(16, 239);
			this->button1->Margin = System::Windows::Forms::Padding(2);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(143, 24);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(16, 183);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(16, 134);
			...
			this->label1->Location = System::Drawing::Point(371, 204);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(267, 27);
			this->label1->TabIndex = 1;
			this->label1->Text = L"FACULTY DASHBOARD";
			// 
			// panel8
			// 
			this->panel8->Location = System::Drawing::Point(250, 463);
			this->panel8->Margin = System::Windows::Forms::Padding(2);
			this->panel8->Name = L"panel8";
			this->panel8->Size = System::Drawing::Size(4, 4);
			...
			this->ClientSize = System::Drawing::Size(814, 501);
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	FacutlyProfile^ fprofile = gcnew FacutlyProfile(userEmail);
	fprofile->Show();
}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	FacultyAccess^ faccess = gcnew FacultyAccess(userEmail);
	faccess->Show();
	
}
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	FacultyGrades^ fgrades = gcnew FacultyGrades(userEmail);
	fgrades->Show();
}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	FacultyCourse^ fcourses = gcnew FacultyCourse(userEmail);
