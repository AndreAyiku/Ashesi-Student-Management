...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel7->Location = System::Drawing::Point(-22, -289);
			this->panel7->Name = L"panel7";
			this->panel7->Size = System::Drawing::Size(265, 1686);
			this->panel7->TabIndex = 14;
			this->panel7->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &enrollmentHistory::panel7_Paint);
			// 
			// button1
			// 
			...
			this->panel1->Location = System::Drawing::Point(243, -4);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.875F, System::Drawing::FontStyle::Bold));
			this->label2->Location = System::Drawing::Point(256, 193);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(465, 45);
			...
			this->dataGridView1->Location = System::Drawing::Point(264, 249);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 82;
			this->dataGridView1->RowTemplate->Height = 33;
			this->dataGridView1->Size = System::Drawing::Size(1123, 830);
			...
			this->ClientSize = System::Drawing::Size(1399, 1108);
			this->Controls->Add(this->dataGridView1);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->panel1);
			this->Controls->Add(this->panel7);
			this->Name = L"enrollmentHistory";
			this->Text = L"enrollmentHistory";
